...
const Welcome = () => {
    ...
    return (
        <>
            ...
            <header>
                ...
                <nav>
                    <ul className="navigation">
                        ...
                        <li><Link href={route("login")} className="btn" id="btnLogin">Login</Link></li>
                        <li><Link href={route("register")} className="btn" id="btnRegister">Register</Link></li>
                    </ul>
                </nav>
            </header>
            ...
            {/* Services */}
            <section id="service" className="class">
                <div className="title-class">
                    <h2>Services</h2>
                    <p>Here's the services that we build for you</p>
                </div>
                <div className="content">
                    <div className="box">
                        <div className="imgbox box2">
                            <img src="assets/service1.jpg" alt="gambar-services" />
                        </div>
                        <div className="text">
                            <h3>Workout</h3>
                        </div>
                    ...
                    <div className="box">
                        <div className="imgbox box2">
                            <img src="assets/service2.jpg" alt="gambar-services" />
                        </div>
                        <div className="text">
                            <h3>Gym</h3>
                        </div>
                    ...
                    <div className="box">
                        <div className="imgbox box2">
                            <img src="assets/service3.jpg" alt="gambar-services" />
                        </div>
                        <div className="text">
                            <h3>Leg Day</h3>
                        </div>
                ...
                <div className="title-class">
                    {/* <a href="https://mercubuana.ac.id/" className="btn" target="_blank">Lihat Semua</a> */}
                    <a href="/login" className="btn">Lihat Semua</a>
                    {/* <Link href={route("login")} className="btn" id="btnLogin">Login</Link> */}
                </div>
            </section>
            ...
            {/*  */}
            {/* contact us */}
            <section className="contact-section pt-32 px-8 py-12 contact bg-black min-h-screen" id="contact">
                <div className="mb-10"></div>

                <div className="flex flex-col lg:flex-row gap-10">
                    {/* Contact Info */}
                    <div className="w-full lg:w-1/2 text-white text-center">
                        <h2 className="text-3xl font-bold text-white text-center mb-2 mt-12">Head Office Healthify</h2>
                        <div className="mx-auto mb-10" style={{ width: '160px', borderBottom: '3px solid #ff9000' }}></div>
                        <div className="space-y-2 mb-6">
                            <p className="text-white">Jl. Meruya Selatan No.1, RT.4/RW.1,</p>
                            <p className="text-white">Joglo, Kecamatan Kembangan,</p>
                            <p className="text-white">Kota Jakarta Barat,</p>
                            <p className="text-white">Daerah Khusus Ibukota Jakarta 11650</p>
                        </div>
                        ...
                        <h3 className="text-primary text-2xl font-semibold">
                            <a href="https://wa.me/6287854592659"
                                target="_blank">0878-5459-2659</a>
                        </h3>
                    </div>
            ...
            <footer className="text-center py-3 text-white-50 bg-black">
                ...
                <small className="d-block mt-2 text-white">All Rights Reserved. © 2025 Kelompok 9</small>
            </footer>
        </>
    );
};
