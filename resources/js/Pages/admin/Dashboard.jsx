...
export default function Dashboard() {
    ...
    const membershipData = statusChart.map((item) => {
        ...
        if (item.status === "Accepted")
            ...
            color = isDarkMode ? "#FBBF24" : "#EAB308";
    ...
    const membershipCategoryData = categoryChart.map((item) => {
        ...
        if (
            item.membership === "Pilates+ Membership" ||
            item.membership === "PilatesPlus Membership"
        ) {
    ...
    const summaryData = [
        {
            ...
            (membershipData.find((item) => item.name === "Pending")?.value || 0),
        ...
        },
        {
            ...
            value:
                membershipData.find((item) => item.name === "Accepted")
                    ?.value || 0,
            icon: (
                <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        },
        {
            ...
            value:
                membershipData.find((item) => item.name === "Pending")?.value ||
                0,
            icon: (
                <svg
                    xmlns="http://www.w3.org/2000/svg"
    ...
    const CustomTooltip = ({ active, payload, label }) => {
        if (active && payload && payload.length) {
            return (
                <div
                    className={`${colors.bgPrimary} p-3 border ${colors.borderColor} rounded-md shadow-lg`}
                >
    ...
    return (
        <AdminLayout title="Dashboard">
            ...
            <div className="p-6 space-y-6 overflow-auto h-full pb-24">
                ...
                <div className="mb-8">
                    <h2
                        className={`text-2xl font-bold ${colors.textPrimary} flex items-center gap-2`}
                    >
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p
                                        className={`text-2xl font-bold ${colors.textPrimary} mt-1`}
                                    >
                                        {item.value}
                                    </p>
                                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Pie Chart Card */}
                    <div
                        className={`${colors.bgPrimary} p-6 shadow-lg rounded-xl border ${colors.borderColor} transition-all duration-300 hover:shadow-xl`}
                    >
                        <h3
                        ...
                        {/* <p className={`text-sm ${colors.textSecondary} mb-4`}>
                            Distribution of membership status in the last 30
                            days
                        </p> */}
                    ...
                    >
                        ...
                        {/* <p className={`text-sm ${colors.textSecondary} mb-4`}>
                            Distribution by membership types in the last 30 days
                        </p> */}
                        <ResponsiveContainer width="100%" height={300}>
                            <BarChart
                                data={membershipCategoryData}
                                barSize={65}
                            >
                                <CartesianGrid
                                    strokeDasharray="3 3"
