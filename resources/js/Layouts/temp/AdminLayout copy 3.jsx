...
//     Dumbbell, Settings, Bell, Search, Users
// } from "lucide-react";
...
//                     <Link href={route("admin.users")} className={`flex items-center gap-3 px-4 py-2 rounded-lg ${isActive("admin/users") ? "bg-orange-200 text-black font-semibold shadow" : "text-gray-700 hover:bg-orange-100 hover:text-orange-600"}`}>
...
//                             {notificationOpen && (
//                                 <div className="absolute right-0 mt-3 w-72 sm:w-80 md:w-96 bg-white shadow-2xl rounded-xl overflow-hidden z-50 border border-gray-100 animate-fade-in-up">
...
//                                         </button>
//                                     </div>
//                                     <ul className="max-h-64 sm:max-h-72 overflow-y-auto divide-y divide-gray-100 custom-scrollbar">
//                                         {notifications.length > 0 ? (
//                                             notifications.map((notif) => (
//                                                 <li
//                                                     key={notif.id}
//                                                     className={`p-3 sm:p-4 hover:bg-gray-50 cursor-pointer ${notif.read ? "bg-white" : "bg-blue-50"}`}
//                                                 >
...
//                                         className="block w-full text-center py-3 text-blue-600 font-medium hover:bg-gray-50 text-sm sm:text-base"
//                                     >
//                                         View All
//                                     </Link>
//                                 </div>
